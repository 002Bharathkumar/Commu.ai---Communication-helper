...
predictor = dlib.shape_predictor(r"C:\Users\Bharath kumar\OneDrive\Desktop\Communication helper\Communication helper\v1\shape_predictor_68_face_landmarks.dat")
...
def analyze_audio(duration):
    ...
    with sr.Microphone() as source:
        ...
        print("Recording audio for {} seconds.Plese speak loudly and sit in a lighted area.".format(duration))
